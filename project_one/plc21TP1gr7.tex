...
\begin{itemize}
    ...
    caption=Database Input (Label \ref{dataJSON})]{data.csv}
...
\item The following test, however is a more generic input that tests 
    ...
    caption=Students input (Label \ref{alunosJSON})]{alunos.csv}
\item The final test consolidates all the previous tests, having both
    ...
    caption=Students with averages input (Label \ref{alunos1JSON})]{alunos1.csv}
\end{itemize}
...
\lstinputlisting[label={dataJSON},
                 caption=Database output (Label \ref{dataCSV})]{data.json}
\lstinputlisting[label={alunosJSON},
                 caption=Students output (Label \ref{alunosCSV})]{alunos.json}
\lstinputlisting[label={alunos1JSON},
                 caption=Students average output (Label \ref{alunos1CSV})]{alunos1.json}
